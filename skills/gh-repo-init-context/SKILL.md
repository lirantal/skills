...
2. Create or update `AGENTS.md`:
   ...
   - If an existing `AGENTS.md` has project rules, preserve them unless they conflict with the requested convention; prefer the template as the stable skeleton.
